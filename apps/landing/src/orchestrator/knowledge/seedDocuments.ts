...
export const SEED_KNOWLEDGE_DOCUMENTS: KnowledgeDocument[] = [
  ...
  },
  {
    ...
    categoria: "COMISSOES",
    conteudo:
      "A comissão da revendedora varia de 30% a 40%, dependendo do valor total vendido em cada acerto: até R$ 299,00 a comissão é de 30%; de R$ 299,01 a R$ 399,99 é de 35%; a partir de R$ 400,00 é de 40%. Quanto mais a revendedora vende em cada ciclo, maior a porcentagem que ela recebe.",
